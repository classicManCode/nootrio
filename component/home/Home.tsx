  ...
  return (
    ...
    <main>
      ...
      <section className="h-[80vh] w-full bg-white flex items-center justify-center">
        <div className="flex items-center justify-center gap-10 h-full w-[80vw] bg-black">
          <Image
          ...
          <div className="flex flex-col items-start justify-center gap-10 h-[60vh]">
            <h2 className="border border-white py-2 px-3 rounded-full">About</h2>
            <div className="max-w-xl flex flex-col gap-4">
              <p>Are you wondering about different ways to stay healthy?</p>
              <p>
